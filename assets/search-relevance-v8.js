(function () {
  ...
  window.ykSearchRelevanceConfig = {
    ...
    concepts: [
      ...
      {
        id: "sailor_uniform",
        aliases: ["セーラー服", "セーラー", "せーらーふく", "セーラータイプ", "セーラー型", "sailor uniform"],
        related: ["uniform"]
      },
      {
        id: "gakuran",
        aliases: [
          ...
          "詰襟", "詰衿", "詰め襟", "詰め衿", "詰めえり",
          "つめえり", "つめ襟", "つめ衿",
          "詰襟学生服", "詰襟制服", "詰襟タイプ", "学ランタイプ", "スタンドカラー制服",
          "gakuran", "tsumeeri uniform", "stand collar uniform", "standing collar school uniform"
        ],
        related: ["uniform"]
      },
      {
        ...
        aliases: [
          ...
          "ブレザージャケット", "ブレザータイプ", "紺ブレ", "blazer", "school blazer", "blazer uniform"
        ],
        related: ["uniform"]
      },
      {
        ...
        aliases: [
          ...
          "uniform suit", "school uniform suit", "school suit"
        ],
        related: ["uniform"]
      },
      {
        id: "uniform_eton",
        aliases: [
          "イートン", "イートン服", "イートン型", "イートンタイプ", "イートン型制服", "イートンジャケット",
          "eton", "eton uniform", "eton school uniform", "eton jacket"
        ],
        related: ["uniform"]
      },
      {
        id: "uniform_upper",
        aliases: [
          "制服上衣", "学生服上衣", "制服上着", "学生服上着",
          "学ラン上衣", "学ラン上着", "詰襟上衣", "詰襟上着",
          "詰め襟上衣", "詰め襟上着", "つめえり上衣", "つめえり上着",
          "イートン上衣", "イートン上着",
          "school uniform jacket", "uniform upper garment"
        ],
        related: ["uniform", "outerwear"]
      },
      {
        id: "uniform_slacks",
        aliases: [
          "スラックス", "制服スラックス", "学生スラックス", "スクールスラックス",
          "学生ズボン", "制服ズボン", "標準ズボン", "標準型学生ズボン",
          "学ランズボン", "学ラン用ズボン", "がくらんズボン", "がくらん用ズボン",
          "詰襟ズボン", "詰襟用ズボン", "詰め襟ズボン", "詰め襟用ズボン",
          "つめえりズボン", "つめえり用ズボン",
          "学ランスラックス", "学ラン用スラックス", "詰襟スラックス", "詰襟用スラックス",
          "詰め襟スラックス", "詰め襟用スラックス", "つめえりスラックス", "つめえり用スラックス",
          "slacks", "uniform slacks",
          "school slacks", "student slacks"
        ],
        related: ["uniform"]
      },
      {
        id: "uniform_skirt",
        aliases: [
          "制服スカート", "学生スカート", "スクールスカート",
          "school uniform skirt", "school skirt"
        ],
        related: ["uniform", "skirt"]
      },
      {
        id: "uniform_knit",
        aliases: [
      ...
      },
      {
        ...
        aliases: [
          "ズボン", "パンツ", "ストレートパンツ",
          "pants", "trousers", "long pants", "bottoms"
        ],
